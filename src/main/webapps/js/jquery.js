            ...
            _Deferred: function () {
                var // callbacks list
                        ...
                        deferred = {
                            ...
                            resolve: function () {
                                deferred.resolveWith(jQuery.isFunction(this.promise) ? this.promise() : this,
                                        arguments);
                                return this;
                            },
...
// Create "bubbling" focus and blur events
    ...
    function liveHandler(event) {
        ...
        if (event.liveFired === this || !events || !events.live || event.target.disabled || event.button &&
            event.type === "click") {
            return;
        }
        ...
        for (i = 0, l = match.length; i < l; i++) {
            ...
            for (j = 0; j < live.length; j++) {
                ...
                if (close.selector === handleObj.selector &&
                    (!namespace || namespace.test(handleObj.namespace)) && !close.elem.disabled) {
                    elem = close.elem;
                    related = null;
...
// Create transport if the browser can provide an xhr
    ...
    jQuery.fn.extend({
        ...
        fadeTo: function (speed, to, easing, callback) {
            return this.filter(":hidden").css("opacity", 0).show().end().animate({opacity: to}, speed, easing,
                    callback);
        },
    ...
    jQuery.each(["Height", "Width"], function (i, name) {
        ...
        jQuery.fn[type] = function (size) {
            ...
            if (jQuery.isWindow(elem)) {
                // Everyone else use document.documentElement or document.body depending on Quirks vs Standards
                // mode 3rd condition allows Nokia support, as it supports the docElem prop but not CSS1Compat
