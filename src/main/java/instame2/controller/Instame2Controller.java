...
public class Instame2Controller {
    ...
    public ModelAndView register(@RequestParam("code") String code,
                                 @RequestParam("me2dayUserId") String me2dayUserId) throws Exception {
    ...
    public ModelAndView registerSubscriptions(
            @RequestParam(value = "hub.challenge", required = false) String instagramAuthKey) throws Exception {
    ...
    public ModelAndView saveMe2DayKey(@RequestParam("user_id") String userId,
                                      @RequestParam("user_key") String userKey) throws Exception {
        return new ModelAndView("redirect:login.nj?userId=" + userId + "&userKey=" + userKey);
    }

    @RequestMapping("/leave")
    public String leave(@RequestParam("me2dayId") String me2dayId,
                        @RequestParam("instagramUserName") String instagramUserName) throws Exception {
    ...
    public ModelAndView login(@RequestParam("userId") String userId, @RequestParam("userKey") String userKey)
            throws Exception {
