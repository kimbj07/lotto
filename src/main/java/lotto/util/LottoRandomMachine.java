...
public class LottoRandomMachine {
    ...
    // 로또 번호 셋
    private static final HashSet<Integer> NUMBERS = new HashSet<Integer>(
    ...
    public static Set<Integer> recommendNumbers(List<GameInfoForDB> gameInfos,
                                                List<AppearanceCount> appearanceCounts) {
    ...
    public static Set<Integer> recommendNumbers(List<GameInfoForDB> gameInfos,
                                                List<AppearanceCount> appearanceCounts,
                                                Set<Integer> excludeNumbers, Set<Integer> includeNumbers) {
        // 1. 선택 가능한 번호 생성
...
//		addAndRemoveChoicedNumber(recommendedNumbers, numbers, randomNumber);
    ...
    public static Set<Integer> recommendExceptionNumbers(List<GameInfoForDB> gameInfos,
                                                         List<AppearanceCount> appearanceCounts) {
        // 1. 선택 가능한 번호 생성
     ...
     */
    static void removeIncludeExcludeNumbers(Set<Integer> numbers, Set<Integer> includeNumbers,
                                            Set<Integer> excludeNumbers) {
     ...
     */
    private static void addAndRemoveChoicedNumber(Set<Integer> recommendedNumbers, Set<Integer> numbers,
                                                  Integer choicedNumber) {
    ...
    private static Integer chooseBetweenFromAndToRandomly(List<AppearanceCount> appearanceCounts) {
        ...
        int index = RandomUtils.nextInt(MAX_APPEARANCE_TO_INDEX - MAX_APPEARANCE_FROM_INDEX + 1)
                    + MAX_APPEARANCE_FROM_INDEX - 1;
     ...
     * @param appearanceCounts - 가장 많이 나온 순으로 정렬된 번호 목록
     */
    private static void removeThreeMaxAppearancedNumber(Set<Integer> numbers,
                                                        List<AppearanceCount> appearanceCounts) {
        if (CollectionUtils.isEmpty(appearanceCounts)) {
            return;
        }
