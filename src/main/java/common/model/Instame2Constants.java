...
public class Instame2Constants {
    ...
    public static final String INSTAGRAM_USER_AUTHORIZATION_URL =
            "https://api.instagram.com/oauth/authorize/?response_type=code&client_id=" + CLIENT_ID
            + "&redirect_uri=" + Instame2Constants.REGISTER_URL;
    ...
    public static final String INSTAGRAM_FEED_URL =
            "https://api.instagram.com/v1/users/self/media/recent?access_token=";
    public static final String INSTAGRAM_DELETE_URL =
            "https://api.instagram.com/v1/subscriptions?client_secret=" + CLIENT_SECRET + "&client_id="
            + CLIENT_ID + "&id=";

    public static final NameValuePair[] DEFAULT_PARAMS = {
            new NameValuePair("client_id", CLIENT_ID), new NameValuePair("client_secret", CLIENT_SECRET)
    };
    public static final NameValuePair[] SUBSRIPTIONS_PARAMS = {
            new NameValuePair("aspect", "media"), new NameValuePair("object", "user"), new NameValuePair(
            "callback_url", Instame2Constants.SUBSCRIPTION_URL)
    };

    // 미투데이에서 필요한 상수
    public static final String ME2DAY_AUTH_KEY = "cef61312608d17fb9807f1c79a382905";
    public static final String ME2DAY_GET_AUTH_URL =
            "http://me2day.net/api/get_auth_url.json?akey=" + ME2DAY_AUTH_KEY;
