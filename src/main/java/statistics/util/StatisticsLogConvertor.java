...
public class StatisticsLogConvertor {
	public static StatisticsLog toStatisticsLog(String rawData) {
		// 톰캣 로깅 시간 추출
		String loggingTime = StringUtils.substring(rawData, 0, Instame2Constants.TOMCAT_LOGGING_TIME_FORMAT.length());

		// 액션 및 메시지 추출
		String refinedLog = StringUtils.substringBetween(rawData, Instame2Constants.STATISTICS_OPEN, Instame2Constants.STATISTICS_CLOSE);
