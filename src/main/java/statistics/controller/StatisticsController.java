...
public class StatisticsController {
	...
	public ModelAndView showStatisticsCount(String startDate, String endDate, @RequestParam(defaultValue = "all") String actionType) throws Exception {
		...
		mav.addObject("instame2StatisticsCount", statisticsBO.acquireStatisticsCount(fromDate, toDate, actionType));
		return mav;
	}

	@RequestMapping("/showRawStatistics")
	public ModelAndView showRawStatistics(@RequestParam(defaultValue = "1") Integer page, @RequestParam(defaultValue = "10") Integer pageSize, String startDate, String endDate) throws Exception {
		String fromDate = checkDateIfInvalidReturnNDaysAgo(startDate, 7);
		String toDate = checkDateIfInvalidReturnNDaysAgo(endDate, 0);
		...
		mav.addObject("instame2RawStatistics", statisticsBO.acquireRawStatistics(fromDate, toDate, page, pageSize));
		return mav;
	}
